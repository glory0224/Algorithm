...
for tc in range(1, 11):
    ...
    # 대각선 합계
    crossline_sum1 = sum(matrix[i][i] for i in range(100))
    crossline_sum2 = sum(matrix[i][99-i] for i in range(100))

    # 최대 값 찾기
    max_sum = max(max(row_sum), max(col_sum), crossline_sum1, crossline_sum2)
